...
def keygen_luov():
    ...
    try:
        with open("LUOV-47-42-182/sk.txt", "wb") as sk_file:
    ...
    try:
        with open("LUOV-47-42-182/pk.txt", "wb") as pk_file:
