...
def keygen_luov():
    ...
    try:
        with open("LUOV-79-76-341/sk.txt", "wb") as sk_file:
    ...
    try:
        with open("LUOV-79-76-341/pk.txt", "wb") as pk_file:
